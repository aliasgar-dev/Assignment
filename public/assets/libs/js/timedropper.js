        ...
        return $(this).each(function () {
            ...
            $("head").append(
                "<style>#td-clock-" +
                    _td_id +
                    " .td-clock {color:" +
                    _td_options.textColor +
                    ";background: " +
                    _td_options.backgroundColor +
                    "; box-shadow: 0 0 0 1px " +
                    _td_options.borderColor +
                    ",0 0 0 8px rgba(0, 0, 0, 0.05); } #td-clock-" +
                    _td_id +
                    " .td-clock .td-time span.on { color:" +
                    _td_options.primaryColor +
                    "} #td-clock-" +
                    _td_id +
            ...
            _td_c
                .find("svg")
                .attr("style", "stroke:" + _td_options.borderColor);
            ...
            var _td_init_deg = -1,
                ...
                _td_rotation = function (deg) {
                    ...
                    var _td_h = _td_c
                            .find(".td-time span:first")
                            .attr("data-id"),
                        _td_m = _td_c
                            .find(".td-time span:last")
                            .attr("data-id");
            ...
            var _td_init = function (value) {
                ...
                if (_td_input.val().length && !_td_options.setCurrentTime) {
                    ...
                    if (st) {
                        ...
                        m = st[1].match(reg);
                        if (
                            _td_input.val().indexOf("am") != -1 ||
                            _td_input.val().indexOf("AM") != -1 ||
                            _td_input.val().indexOf("pm") != -1 ||
                            _td_input.val().indexOf("PM") != -1
                        ) {
                            if (
                                _td_input.val().indexOf("am") != -1 ||
                ...
                _td_c
                    ...
                    .css(
                        "transform",
                        "rotate(" + Math.round((m * 360) / 59) + "deg)"
                    );
            ...
            _td_input.click(function (e) {
                ...
                _td_container
                    .addClass("td-show")
                    .addClass("td-" + _td_options.init_animation);
                _td_c.css({
                    top: _td_input.offset().top + (_td_input.outerHeight() - 8),
                    left:
                        _td_input.offset().left +
                        _td_input.outerWidth() / 2 -
                        _td_c.outerWidth() / 2
                });
            ...
            _td_overlay.click(function () {
                _td_container
                    .addClass("td-fadeout")
                    .removeClass("td-" + _td_options.init_animation);
