    ...
    $.fn.dateDropper = function (options) {
        return $(this).each(function () {
            if ($(this).is("input") && $(this).attr("type") == "text") {
                var t_y_cur = new Date().getFullYear(),
                    t_d_cur = new Date().getDate(),
                    t_m_cur = new Date().getMonth();

                var _dd_m, _dd_d, _dd_y, _dd_sub_y;

                var _dd_id = $(".dd-w").length;
                ...
                $(
                    "<style>#dd-w-" +
                        ...
                        _dd_id +
                        " .dd-s-b-ul ul { width:" +
                        _dd_settings.dropWidth +
                        "px; } #dd-w-" +
                        _dd_id +
                        " .dd-w-c{color:" +
                        _dd_settings.dropTextColor +
                        ";background:" +
                        _dd_settings.dropBackgroundColor +
                        ";border:" +
                        _dd_settings.dropBorder +
                        ";box-shadow:" +
                        _dd_settings.dropShadow +
                        ";border-radius:" +
                        _dd_settings.dropBorderRadius +
                        "px}#dd-w-" +
                        _dd_id +
                        " .dd-w-c,#dd-w-" +
                        _dd_id +
                        ...
                        _dd_color(_dd_settings.dropPrimaryColor, -20) +
                        "; }</style>"
                ).appendTo("head");
                ...
                var _dd_init = function () {
                        _dd.find(".dd-d li,.dd-s-b li").show();

                        if (_dd_isB(_dd_y) && _dd_m == 2) {
                            _dd.find(".dd-d ul").width(
                                29 * _dd_settings.dropWidth
                            );
                            ...
                            _dd.find(".dd-d ul").width(
                                28 * _dd_settings.dropWidth
                            );
                            if (_dd_d == 29 || _dd_d == 30 || _dd_d == 31) {
                                _dd_d = 28;
                            }
                            _dd.find(
                                "li[data-id=29],li[data-id=30],li[data-id=31]"
                            ).hide();
                        } else if (
                            _dd_m == 4 ||
                            _dd_m == 6 ||
                            ...
                            _dd.find(".dd-d ul").width(
                                31 * _dd_settings.dropWidth
                            );
                        }

                        _dd.find(".dd-d li").each(function (index, element) {
                            var _d = $(this).attr("data-id"),
                        ...
                        _dd.find(".dd-s-b-d li").each(function (
                            index,
                            element
                        ) {
                            var _d = $(this).attr("data-id"),
                        ...
                        if (!_dd_settings.animate) {
                            setTimeout(function () {
                                _dd.find(".dd-d .dd-ul").scrollLeft(
                                    _dd
                                        .find(
                                            '.dd-d li[data-id="' + _dd_d + '"]'
                                        )
                                        .index() * _dd_settings.dropWidth
                                );
                                _dd.find(".dd-m .dd-ul").scrollLeft(
                                    _dd
                                        .find(
                                            '.dd-m li[data-id="' + _dd_m + '"]'
                                        )
                                        .index() * _dd_settings.dropWidth
                                );
                                _dd.find(".dd-y .dd-ul").scrollLeft(
                                    _dd
                                        .find(
                                            '.dd-y li[data-id="' + _dd_y + '"]'
                                        )
                                        .index() * _dd_settings.dropWidth
                                );
                                _dd.find(".dd-sub-y .dd-ul").scrollLeft(
                                    _dd
                                        .find(
                                            '.dd-sub-y li[data-id="' +
                                                _dd_sub_y +
                    ...
                    _dd_placement = function () {
                        ...
                        */
                        ...
                        _dd.find(".dd-c")
                            .css({
                                top:
                                    _dd_input.offset().top +
                                    _dd_input.innerHeight() -
                                    6,
                                left:
                                    _dd_input.offset().left +
                                    (_dd_input.innerWidth() / 2 -
                                        _dd_settings.dropWidth / 2)
                            })
                    ...
                    _dd_submit = function () {
                        ...
                        var x = new Date(_dd_m + "/" + _dd_d + "/" + _dd_y),
                            x = x.getDay();

                        var str = _dd_settings.format
                    ...
                    _dd_calculate = function (y) {
                        ...
                        if (_i_max > _dd_settings.maxYear)
                            _i_max = _dd_settings.maxYear;

                        for (var i = _i; i <= _i_max; i++) {
                            if (i % _dd_settings.yearsRange == 0)
                                var _d_c_y = i;

                            _dd.find(".dd-s-b-s-y ul").append(
                                '<li data-id="' +
                                    i +
                                    '" data-filter="' +
                                    _d_c_y +
                        ...
                        _dd.find(".dd-sub-y .dd-ul").scrollLeft(
                            _dd
                                .find(
                                    '.dd-sub-y li[data-id="' + _dd_sub_y + '"]'
                                )
                                .index() * _dd_settings.dropWidth
                        );

                        _dd.find(".dd-s-b-s-y li").each(function (
                            index,
                            element
                        ) {
                            $(this).click(function () {
                                ...
                                _dd.find(".dd-s-b-y,.dd-s-b-s-y").removeClass(
                                    "dd-show"
                                );
                    ...
                    _dd_construct = function () {
                        _dd.find(".dd-s-b").each(function (index, element) {
                            ...
                            if (
                                _dd_el.hasClass("dd-s-b-m") ||
                                _dd_el.hasClass("dd-s-b-d")
                            ) {
                            ...
                            if (_dd_el.hasClass("dd-s-b-y")) {
                                for (
                                    var i = _dd_settings.minYear;
                                    i <= _dd_settings.maxYear;
                                    i++
                                ) {
                                    if (i % _dd_settings.yearsRange == 0)
                                        _dd_el
                        ...
                        _dd.find(".dd-b").each(function (index, element) {
                            ...
                            if (_dd_el.hasClass("dd-m")) {
                                ...
                                _dd_el.find("li").click(function () {
                                    if (
                                        _dd_settings.format == "m" ||
                                        _dd_settings.format == "n" ||
                                        _dd_settings.format == "F" ||
                                        _dd_settings.format == "M"
                                    )
                                        return false;
                        ...
                        _dd.find(".dd-o").click(function () {
                            _dd.find(".dd-c")
                                .addClass("dd-fadeout")
                                .removeClass(
                                    "dd-" + _dd_settings.init_animation
                                );
                    ...
                    _dd_set = function () {
                        ...
                        if (_dd.hasClass("dd-init")) {
                            ...
                            if (
                                parseInt(_dd_input.attr("data-d")) &&
                                parseInt(_dd_input.attr("data-d")) <= 31
                            )
                                _dd_d = parseInt(_dd_input.attr("data-d"));

                            if (
                                parseInt(_dd_input.attr("data-m")) &&
                                parseInt(_dd_input.attr("data-m")) <= 11
                            )
                                _dd_m = parseInt(_dd_input.attr("data-m")) + 1;

                            if (
                                parseInt(_dd_input.attr("data-y")) &&
                                _dd_input.attr("data-y").length == 4
                            )
                                _dd_y = parseInt(_dd_input.attr("data-y"));

                            if (_dd_y > _dd_settings.maxYear)
                                _dd_settings.maxYear = _dd_y;
                            if (_dd_y < _dd_settings.minYear)
                                _dd_settings.minYear = _dd_y;
